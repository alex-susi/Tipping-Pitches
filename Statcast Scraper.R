...
#'
#' This function allows you to query Statcast and PITCHf/x data as provided on 
#' \url{http://baseballsavant.mlb.com} and have that data returned as a \code{\link{data.frame}}.
...
scrape_statcast_savant.Date <- function(start_date = Sys.Date() - 1, end_date = Sys.Date(),
  ...
  if (start_date <= "2015-03-01") { # March 1, 2015 was the first date of Spring Training.
    message("Some metrics such as Exit Velocity and 
            Batted Ball Events have only been compiled since 2015.")
  }
  ...
  tryCatch(
    {
      message("These data are from BaseballSavant and 
              are property of MLB Advanced Media, L.P. All rights reserved.")
