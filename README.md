...
<img src="https://github.com/alex-susi/Tipping-Pitches/blob/master/Ian%20Kennedy.png" width="600"> <img src="https://github.com/alex-susi/Tipping-Pitches/blob/master/Edwin%20Diaz.png" width="600">
<br/><br/><br/><br/>
...
<img src="https://github.com/alex-susi/Tipping-Pitches/blob/master/Kyle%20Gibson.png" width="600"> <img src="https://github.com/alex-susi/Tipping-Pitches/blob/master/Matt%20Harvey.png" width="600">
...
* For example, with some film study, teams could see that Edwin Diaz regularly throws his slider from a higher release point than his fastball. Batters facing him could use this to quickly make a decision as to what pitch they are about to see when Diaz releases the ball.
* On the contrary, if Ian Kennedy, Edwin Diaz, or one of the other pitchers that scored high on the accuracy test were to see these results, they may want to modify their pitching mechanics such that they don't always release a given pitch type from a similar point. This may help prevent opposing batters from being able to tell what pitch they are about to see.
* As I said, this analysis is far from perfect for determing every pitcher who has a tendency to tip pitches. There are many factors that could hint at what kind of pitch a pitcher is about to throw that aren't currently recorded by Statcast (changes in windup, positioning of the glove, where they stand on the rubber, etc.). If Statcast were to start tracking this, it would be interesting to revisit this problem and see what the new results are.   
